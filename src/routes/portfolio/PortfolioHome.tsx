...
export default function PortfolioHome() {
  ...
  return (
    <div className="portfolio-motion" ref={revealRef}>
      <section
      ...
      <section className="w-full bg-slate-50 px-6 py-20" data-reveal id="links">
        <div className="mx-auto max-w-5xl">
          <h2 className="mb-14 text-center text-5xl font-bold tracking-tight text-slate-900">
            Links
          </h2>
      ...
      <section className="w-full bg-white px-6 py-20" data-reveal id="works">
      ...
      <section className="w-full bg-white px-6 py-20" data-reveal id="articles">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 flex items-center justify-between">
            <h2 className="text-5xl font-bold tracking-tight text-slate-900">
              Articles
