...
const PublicEthicsPage_final = () => {
  return (
    <div className="public-ethics-page">
      <h1>共通テスト対策【公共・倫理】（最終版）</h1>

      <div className="public-ethics-intro">
        <p>
          共通テスト「公共・倫理」の対策に役立つ学習ツールです。
          【最終版】では、情報量を削り、必要最低限の情報を感覚的に覚えることを目的にしています。やや雑になっていますが、情報量を削った結果です。
          直前期の確認にご活用ください。
        </p>
      ...
      <div className="public-ethics-cards">
        <Link className="public-ethics-card" to="/thinkers_final">
          <div className="card-icon">📚</div>
          <h2>思想家一覧</h2>
          <p>
            共通テストでよく出題される思想家の情報を一覧で確認できます。
            各思想家の説明、主著、宗教などの詳細情報をまとめて確認できます。
          </p>
          <div className="card-link">一覧を見る →</div>
        </Link>

        <Link className="public-ethics-card" to="/thinkers_quiz_final">
...
export default PublicEthicsPage_final;
